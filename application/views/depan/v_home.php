...
<section class="our_courses" style="background-color: #F5FAFF; margin-top:-50px;">
    <div class="container">
        ...
        <div class="row">
                ...
                <div class="card courses_box mb-4">
                    <img style="background-color: rgba(22, 160, 133, 0.1); " src="<?php echo base_url() . 'theme/images/logo/webinar1.png' ?>"> 
                        <div class="card-body">
                            ...
                            <p style="margin-left:15px; margin-right:15px;">Pelayanan kegiatan seminar yang dilakukan secara online dengan menggunakan media zoom meet, selama 10 kali sesi pertemuan yang di lakukan oleh pihak scopus dalam melayani pendampingan jurnal</p>
                            <center>
                ...
                <div class="card courses_box mb-4">
                    <img style="background-color:  rgba(213, 15, 37, 0.1)" src="<?php echo base_url() . 'theme/images/logo/camp.png' ?>"> 
                        <div class="card-body">
                            ...
                            <hr size="6px" width="50%" align="center" color="orange">
                            <p style="margin-left:15px; margin-right:15px;">Memberikan pelatihan penulisan paper yang berjalan selama 3 hari secara offline atau tatap muka. Pada Scopus Camp ini bertempat di Rumah Scopus pusat yang berada di Turi Sleman dan Cabang Rumah Scopus, dengan Trainer yang sudah Profesional</p>
                            <center>
                ...
                <div class="card courses_box mb-4"> 
                    <img style="background-color:  rgba(250, 188, 9, 0.1)" src="<?php echo base_url() . 'theme/images/logo/toga.png' ?>"> 
                        <div class="card-body">
                            ...
                            <hr size="6px" width="50%" align="center" color="orange">
                            <p style="margin-left:15px; margin-right:15px;">Memberikan layanan dalam penyusunan paper yang bereputasi internasional yang terindeks Scopus, dengan para trainer berpengalaman dan profesional dalam penyusunan paper</p>
                            <center>
            ...
            <div class="col-xs-12 col-sm-6 col-md-6 col-lg-3">
                <div class="card courses_box mb-4">
                    <img style="background-color: rgba(121, 90, 71, 0.1)" src="<?php echo base_url() . 'theme/images/logo/workshop.png' ?>"> 
                        <div class="card-body">
                            <center>
                                <h5 class="card-title mt-3 mb-2" ><b>Workshop Penulisan Artikel Ilmiah</b></h5>
                            </center>
                            <hr size="6px" width="50%" align="center" color="orange">
                            ...
                            <center>
                                <a href="https://api.whatsapp.com/send?phone=+6281226883280&text=Hallo%20kak!,%20Saya%20ingin%20informasi%20terkait%20program%20Workshop%20Penulisan%20Artikel%20Ilmiah%20di%20Rumah%20Scopus." class="btn btn-warning mb-3 mt-3" style="color:white; border-radius:30px; background-color:orange;">
                                    Pesan Sekarang!
                                </a>
                            </center>
                        </div>
            ...
            <div class="col-lg-6">
                ...
                <div class="row">
                    ...
                    <div class="col-sm-9 mt-2"> 
                        ...
                        <a href="<?php echo site_url('artikel');?>" class="btn btn-warning mt-2" style="color:white; border-radius:30px; background-color:orange; float:right;">
                            Selengkapnya
                        </a>
                        <hr class="event_line">
                    </div>
                ...
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <div class="date-description">
                            ...
                            <p>
                                <i class="fa fa-calendar" aria-hidden="true"> <?php echo date("d M y", strtotime($row->agenda_mulai));?> s/d <?php echo date("d M y", strtotime($row->agenda_selesai));?></i> 
                                | 
                            ...
                            <a href="<?php echo site_url('agenda');?>" class="btn btn-warning" style="color:white; border-radius:30px; background-color:orange; margin-bottom:-30px; float:right;">
                                Selengkapnya
                            </a>
                            <hr class="event_line">
                        </div>
                        ...
                        <div class="col-lg-12">
                            <div class="brand-logo d-flex align-items-center justify-content-center justify-content-md-between">
                                <div class="single-logo mt-30 wow fadeIn" data-wow-duration="1s" data-wow-delay="0.2s">
                                    <img src="<?php echo base_url() . 'theme/images/partner/undip.png' ?>" alt="brand" />
                                </div>

                                <div class="single-logo mt-30 wow fadeIn" data-wow-duration="1.5s" data-wow-delay="0.2s">
                                    <img src="<?php echo base_url() . 'theme/images/partner/unesa.png' ?>" alt="brand" />
                                </div>

                                <div class="single-logo mt-30 wow fadeIn" data-wow-duration="1.5s" data-wow-delay="0.3s">
                                    <img src="<?php echo base_url() . 'theme/images/partner/uins.png' ?>" alt="brand" />
                                </div>

                                <div class="single-logo mt-30 wow fadeIn" data-wow-duration="1.5s" data-wow-delay="0.4s">
                                    <img src="<?php echo base_url() . 'theme/images/partner/uns.png' ?>" alt="brand" />
                                </div>

                                <div class="single-logo mt-30 wow fadeIn" data-wow-duration="1.5s" data-wow-delay="0.5s">
                                    <img src="<?php echo base_url() . 'theme/images/partner/univpakuan.png' ?>" alt="brand"/>
                                </div>

                                <div class="single-logo mt-30 wow fadeIn" data-wow-duration="1.5s" data-wow-delay="0.5s">
                                    <img src="<?php echo base_url() . 'theme/images/partner/iain.png' ?>" alt="brand"/>
                                </div>

                                <div class="single-logo mt-30 wow fadeIn" data-wow-duration="1.5s" data-wow-delay="0.5s">
                                    <img src="<?php echo base_url() . 'theme/images/partner/poltekes.png' ?>" alt="brand"/>
                                </div>

                                <div class="single-logo mt-30 wow fadeIn" data-wow-duration="1.5s" data-wow-delay="0.5s">
                                    <img src="<?php echo base_url() . 'theme/images/partner/uad.png' ?>" alt="brand"/>
                                </div>

                                <div class="single-logo mt-30 wow fadeIn" data-wow-duration="1.5s" data-wow-delay="0.5s">
                                    <img src="<?php echo base_url() . 'theme/images/partner/umy.png' ?>" alt="brand"/>
                                </div>

                                <div class="single-logo mt-30 wow fadeIn" data-wow-duration="1.5s" data-wow-delay="0.5s">
                                    <img src="<?php echo base_url() . 'theme/images/partner/univborobudur.png' ?>" alt="brand"/>
                                </div>

                                <div class="single-logo mt-30 wow fadeIn" data-wow-duration="1.5s" data-wow-delay="0.5s">
                                    <img src="<?php echo base_url() . 'theme/images/partner/upn.png' ?>" alt="brand"/>
                                </div>

                                <div class="single-logo mt-30 wow fadeIn" data-wow-duration="1.5s" data-wow-delay="0.5s">
                                    <img src="<?php echo base_url() . 'theme/images/partner/ust.png' ?>" alt="brand"/>
                                </div>
                            </div>
                        </div>
                    </div>
        ...
        <div class="row">
            ...
            <div class="col-md-12">
                <div class="single-item">
                    ...
                    <div class="quote">
                        <center><img src="<?php echo base_url() . 'theme/images/partner/ust.png' ?>" alt="brand"/></center>
                        <h5 class="card-title mt-3" ><b>Universitas Sarjanawiyata Tamansiswa</b></h5>
                    </div>

                    <div class="quote">
                        <center><img src="<?php echo base_url() . 'theme/images/partner/undip.png' ?>" alt="brand"/></center>
                        <h5 class="card-title mt-3" ><b>Universitas Diponegoro Semarang</b></h5>
                    </div>

                    <div class="quote">
                        <center><img src="<?php echo base_url() . 'theme/images/partner/unesa.png' ?>" alt="brand"/></center>
                        <h5 class="card-title mt-3" ><b>Universitas Negeri Surabaya</b></h5>
                    </div>

                    <div class="quote">
                        <center><img src="<?php echo base_url() . 'theme/images/partner/uinsurakarta.png' ?>" alt="brand"/></center>
                        <h5 class="card-title mt-3" ><b>Universitas Islam Negeri Surakarta</b></h5>
                    </div>

                    <div class="quote">
                        <center><img src="<?php echo base_url() . 'theme/images/partner/unsmaret.png' ?>" alt="brand"/></center>
                        <h5 class="card-title mt-3" ><b>Universitas Sebelas Maret</b></h5>
                    </div>

                    <div class="quote">
                        <center><img src="<?php echo base_url() . 'theme/images/partner/unpak1.png' ?>" alt="brand"/></center>
                        <h5 class="card-title mt-3" ><b>Universitas Pakuan Bogor</b></h5>
                    </div>

                    <div class="quote">
                        <center><img src="<?php echo base_url() . 'theme/images/partner/iain1.png' ?>" alt="brand"/></center>
                        <h5 class="card-title mt-3" ><b>IAIN Ponorogo</b></h5>
                    </div>

                    <div class="quote">
                        <center><img src="<?php echo base_url() . 'theme/images/partner/poltekes1.png' ?>" alt="brand"/></center>
                        <h5 class="card-title mt-3" ><b>Politeknik Kesehatan Semarang</b></h5>
                    </div>

                    <div class="quote">
                        <center><img src="<?php echo base_url() . 'theme/images/partner/uad1.png' ?>" alt="brand"/></center>
                        <h5 class="card-title mt-3" ><b>Universitas Ahmad Dahlan</b></h5>
                    </div>

                    <div class="quote">
                        <center><img src="<?php echo base_url() . 'theme/images/partner/umy1.png' ?>" alt="brand"/></center>
                        <h5 class="card-title mt-3" ><b>Universitas Muhammadiyah Yogyakarta</b></h5>
                    </div>

                    <div class="quote">
                        <center><img src="<?php echo base_url() . 'theme/images/partner/univborobudur1.png' ?>" alt="brand"/></center>
                        <h5 class="card-title mt-3" ><b>Universitas Borobudur Jakarta Timur</b></h5>
                    </div>

                    <div class="quote">
                        <center><img src="<?php echo base_url() . 'theme/images/partner/upn1.png' ?>" alt="brand"/></center>
