        ...
        <div class="row">
                        ...
                        <div class="blog-tiltle_block">
                            ...
                            <div class="blog-icons">
                                <div class="blog-share_block">
                                    <a href="<?php echo site_url('artikel/' . $row->tulisan_slug); ?>" class="btn btn-warning" style="color:white; border-radius:30px; background-color:orange;">
                                        Selengkapnya! <i class="fa fa-eyes" aria-hidden="true"></i>
                                    </a>
                                </div>
                            </div>
                        </div>
            ...
            <div class="col-md-4">
                <form action="<?php echo site_url('blog/search'); ?>" method="get">
                    ...
                    <button type="submit" class="btn btn-warning btn-blogsearch" style="border-radius:30px; background-color:orange">SEARCH</button>
                </form>
