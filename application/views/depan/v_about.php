...
<section class="welcome_about">
    <div class="container">
        <div class="row">
            <div class="col-md-7">
                <h2 >Tentang Kami</h2>
                <hr size="50%" width="40%" align="left" color="orange" style="margin-top: -10px;">
    ...
    <div class="container" style="position: relative;">
        <div class="row" >
            <div class="col-md-5" style="margin: 5px;">
                <center><figure class="clear"><img style="width: 100px; height: 100px; border-radius: 50%;" align="center" src=" <?php echo base_url() .'theme/images/visi.png'?>" alt=""></center>
                <div class="row">
            ...
            <div class="col-md-6" style="margin: 5px;">
                <center><figure class="clear"><img style="width: 100px; height: 100px; border-radius: 50%;" src=" <?php echo base_url() .'theme/images/misi.png'?>" alt=""></center>
                <div class="row">
                    <div class="card mt-3 kotak">
                        <div class="card-body" style="margin: 10px;">
                            <blockquote >
